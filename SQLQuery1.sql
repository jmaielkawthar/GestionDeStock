...
-------------------------------
ID_CATEGORIE int NOT NULL, --clé étrangére de table caterogie
--clé primaire
...
------
ID_Client int NOT NULL, --clé étrangére de table client
--clé primaire 
...
(
ID_Commande int NOT NULL,--clé étrangére de table commande
ID_Produit int NOT NULL , --clé étrangére de table produit
